...
export const UserLoader: FC = (): ReactElement => (
  <div className='relative my-2 grid auto-cols-max grid-flow-col items-center gap-3 rounded-lg border-2 border-gray-100 bg-white px-3 py-1.5 shadow-lg md:py-2.5 md:px-5'>
